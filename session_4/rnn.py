...
class RNN:
    def __init__(self,
        ...
        :param embedding_size: size of
        :param lstm_size: number of
    ...
    def build_graph(self):
        ...
        with tf.variable_scope("rnn_variables", reuse=tf.AUTO_REUSE) as scope:
            # initialize weight, biases of softmax layer
            ...
            # compute loss and output of model
...
def train_and_evaluate_RNN(batch_size, lstm_size):
    with open('../datasets/w2v/vocab-raw.txt', errors='strict') as f:
    ...
    with tf.Session() as sess:
        ...
        while step < MAX_STEP:  # train with 10000 steps of batch
            ...
            if train_data_reader.batch_id == 0:  # if end of epoch
                num_true_preds = 0
